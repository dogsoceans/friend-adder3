...
if __name__ == "__main__":
    ...
    for old_name in ["friend-adder3", "friend-adder3"]:
        rename_and_replace(starting_path, old_name, new_name)

    print(f"Replacement complete. All instances of 'friend-adder3' have been replaced with '{new_name}' in files and folders.")
